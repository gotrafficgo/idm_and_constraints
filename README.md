...
## Abstract
I found the additional constraints largely influence the results of IDM-based traffic flow simulation. I report some of them here. _I don’t think directly implementing the model with arbitrary constraints in coding is a rigorous approach._
